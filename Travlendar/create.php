    ...
    <body>
        ...
        <main>
            <section id="eventForm">
                ...
                Date:<br>
                <input type="date" id="eventDate" name="eventDate" value="<?=date("Y-m-d") ?>"><br><br>
                <b>Time</b><br>
                From:<br>
                <input type="time" id="startTime" name="startTime" value="00:00"><br>
                To:<br>
                <input type="time" id="endTime" name="endTime" value="00:00"><br>
                Where:<br>
                <input type="text" id="eventAddress" name="eventAddress"><br>
                <br>
                ...
                Coming from:<br>
                <input type="text" id="startAddress" name="startAddress"><br>
